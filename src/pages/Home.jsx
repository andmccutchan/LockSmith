        ...
        <div className="d-flex row w-100 mx-auto justify-content-center">
          <div className="col-lg-6 col-md-12 d-flex flex-column align-items-center justify-content-between">
            ...
            <p className="text-light mt-4 border border-light rounded p-3">
              ...
              multiple logins! LockSmith is designed to simplify your online
              experience by securely storing and organizing your passwords in
              one convenient place. With our user-friendly interface, advanced
              security features, and seamless access across devices, you can
